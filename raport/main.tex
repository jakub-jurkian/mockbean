...
\begin{itemize}
    ...
    \item \textbf{Springdoc OpenAPI / Swagger UI} — interaktywna dokumentacja i ręczne testowanie endpointu
    \item \textbf{Python} — skrypty ewaluacyjne i analityczne (\texttt{run\_evaluation.py}, \texttt{bootstrap\_analysis.py}, \texttt{baseline\_cosine.py})
\end{itemize}
...
zaimplementowano w czystym Pythonie baseline oparty na klasycznej reprezentacji
\textit{bag of words} z wagami TF-IDF oraz miarą cosine similarity.
Pipeline replikuje strukturę trybu RAG modeli LLM,
